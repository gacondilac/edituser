...
export default function CreateUser() {
  ...
  const fetchData = () => {
    getUserAPI(staffCode).then((respond) => {
      setUser(respond);
      setDefaultDateOfBirth(new Date(respond.dateofBirth.split("T")[0]));
      console.log(respond.dateofBirth.split("T")[0]);
      //console.log(new Date(respond.dateofBirth.split("T")[0]));
      //console.log(new Date("2001/11/11"));
      ...
      // console.log(new Date(user.dateofBirth.split("T")[0]));
    });
  };
  console.log("sadasd", defaultDateOfBirth);
  ...
  const onSubmit = (data) => {
    let userData = {
      staffCode: staffCode,
      gender: data.gender == null ? user.gender : data.gender,
      type: data.type,
        ...
        <div className="row mb-3">
          ...
          <div className="col-sm-9">
            <Controller
              ...
              // defaultValue={new Intl.DateTimeFormat("en-GB").format(
              //   user.dateOfBirth
              // )}
